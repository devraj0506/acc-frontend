...
<div>
     ...
     <div className='add-name-form'>
       ...
       <h1>Add Location</h1>
       <input className='add-name' value={loc} onChange={(e) => setLoc(e.target.value)} placeholder="ADD Location" type="text" tabIndex="4" required />
     
       <button onClick={HandleLoc}>Submit</button>
     </div>
